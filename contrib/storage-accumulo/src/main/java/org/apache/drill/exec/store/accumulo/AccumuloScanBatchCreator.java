...
public class AccumuloScanBatchCreator implements BatchCreator<AccumuloSubScan>{
  static final org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(org.apache.drill.exec.store.accumulo.AccumuloScanBatchCreator.class);

  @Override
  public ScanBatch getBatch(FragmentContext context, AccumuloSubScan subScan, List<RecordBatch> children)
